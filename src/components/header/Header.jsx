            ...
            <ContentWrapper>
                ...
                <ul className="menuItems">
                    ...
                    <li className="menuItem liveBtn" onClick={() => setShowLive(true)}>
                        <span className="livePulse" />LIVE
                    </li>
                    <li className="menuItem themeToggle" onClick={toggleTheme} title={theme === "dark" ? "Switch to Light" : "Switch to Dark"}>
                        {theme === "dark" ? <HiSun /> : <HiMoon />}
                    </li>
                    {isLoggedIn ? (
                        <li className="menuItem userMenu">
                            <span className="userName"><FiUser />{user?.name?.split(' ')[0]}</span>
                            <button className="logoutBtn" onClick={handleLogout}><FiLogOut /></button>
                        </li>
                    ) : (
                        <li className="menuItem loginBtn" onClick={() => navigate("/login")}>Sign In</li>
                    )}
                </ul>
                ...
                <div className="searchBar">
                    <ContentWrapper>
                        <div className="searchInput">
                            ...
                            />
                            <VscChromeClose className="closeIcon" onClick={() => setShowSearch(false)} />
                        </div>
                    </ContentWrapper>
                </div>
            )}
